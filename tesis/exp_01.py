"""
    En este experimento, se hace selección Ruleta'
"""
...
'''
    ...
    -   El siguiente dígito, el método de selección
        0: ruleta
        1: torneo
        3: elitista
'''
...
def inicio_ga():
    ...
    while nni_max <= 2.15:
        offspring = seleccion_ruleta(q_individuos, copia_poblacion, q_coordenadas)

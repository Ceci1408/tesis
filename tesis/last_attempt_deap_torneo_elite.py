...
def selElitistAndTournament(individuals, k_elite, k_tournament, tournsize):
    return tools.selBest(individuals, k_elite) + tools.selTournament(individuals, k_tournament, tournsize=tournsize)
...
def main():
    ...
    while max(fits) < 2.15:
        ...
        for ind in pop:
            ...
            i += 1
        dataframe.to_csv('puntos_torneos_elite_20200606_2.csv', mode='a', header=False, index=False)

    pickle_file = 'pickle_file_stats_torneo_elite_20200606_2'

...
def main(conn):
    ...
    config_id = conexion_db.insert_config(conn, Q_IND, Q_COORD, MUT_PROB, CROSS_PROB, MUT_ALELO_PROB, TIPO_SELECCION,
                                          TORNEO_TAM, MU_X, MU_Y, SIGMA_X, SIGMA_Y, GENERACION_PARADA)
    ...
    conexion_db.close_connection(conn, config_id)

...
toolbox.register("coordenada", crear_coordenadas)#, q_coord=Q_COORD)
...
def main():
    ...
    while max(fits) < 2.15:
        ...
        for ind in pop:
            ...
            i += 1
        dataframe.to_csv('puntos_ruleta_20200606.csv', mode='a', header=False, index=False)

    pickle_file = 'pickle_file_stats_ruleta_20200606'
